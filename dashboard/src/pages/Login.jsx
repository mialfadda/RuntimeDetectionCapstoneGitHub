  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gray-50 px-6">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
        <h2 className="text-2xl font-bold text-[#1A3A6B] text-center mb-6">Sign In</h2>
        ...
        <p className="mt-5 text-center text-sm text-gray-500">
          Don't have an account? <Link to="/register" className="text-[#2D5FA6] hover:underline font-medium">Sign Up</Link>
        </p>
      </div>
    </div>
  );
